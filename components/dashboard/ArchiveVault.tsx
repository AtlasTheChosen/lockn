...
export default function ArchiveVault({ stacks, onUpdate, className = '' }: ArchiveVaultProps) {
  ...
  if (stacks.length === 0) {
    return (
      <div className={`bg-[var(--bg-card)] rounded-[20px] p-6 border-2 border-[var(--border-color)] ${className}`}>
  ...
  return (
    <div className={`bg-[var(--bg-card)] rounded-[20px] border-2 border-[var(--border-color)] overflow-hidden ${className}`}>
